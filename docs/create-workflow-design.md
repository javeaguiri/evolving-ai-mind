...
- **`user_design_notes`** (step 5a) is passed to step 7 (`analyze_workflow_gaps`) and
  step 12 (`design_workflow_process`) so the left brain can incorporate user intent that
