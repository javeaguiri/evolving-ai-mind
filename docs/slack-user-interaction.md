# Interactivity HANDLING USER INTERACTION IN YOUR SLACK APPS
On this page Handling user interaction in your
Slack apps
...
1. Open the App Management dashboard.
2. Select Interactivity & Shortcuts.
...
- view_submission payloads are receivedwhen a modal is submitted.
...
## Modal responses
> The wonderful thing about triggers is that trigger_ids are wonderful things. They're attached to events and interactions. They expire in three seconds. They're fun fun fun fun fun! But the most wonderful thing about triggers is they can be used only once.
