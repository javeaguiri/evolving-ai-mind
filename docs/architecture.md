...
## 6. PGC Workflow Tables — Designed, Not Yet Bootstrapped

These four tables are designed and ready to add to `init-brain.mjs` bootstrap sequence. They support the PROC layer workflow execution engine.
