...
| `REPLAY` | — | 1 — fire-and-forget | SlackbotFunction (`/replay`) | proc/replay.mjs — starts a replay run (`sourceRunId`) or lists recent runs (none). Inspect/resume of a broken replay is HTTP-only (`docs/arch-replay.md` §9) |
