...
**A10 not exercised this run** (Abort button used instead of `/shutdown`); its filter is unit-tested, live
confirmation deferred to a future break. **Track A remaining:** A8 (dev loop), AC3 (record mode, still never
